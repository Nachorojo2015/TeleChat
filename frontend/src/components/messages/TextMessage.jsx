  ...
  if (user?.username === messageData.sender_username) {
    return (
      <li
        ...
        className="bg-blue-500 rounded-l-xl flex flex-col rounded-b-xl p-2 text-white max-w-xs ml-auto break-words whitespace-pre-line relative"
      >
        ...
        {/* Menú contextual */}
        {showMenu && (
          <div className="absolute top-0 right-5 bg-white text-black rounded shadow-lg z-50 min-w-[120px]">
            <button
